...
This study used a **quantitative, cross-sectional survey design** to assess cybersecurity awareness, digital behaviour, and risk mitigation practices among university students in Nepal. The design supported both:
...
- **Section C (Digital Behaviour / risky online behaviour items):** C1–C7
...
- **DB (Digital Behaviour – risk-oriented items):** mean of C1–C7
- **RMP (Risk Mitigation Practices):** mean of D1–D7

All B/C/D items used a 5-point scale. For DB, higher scores indicate **more risky behaviour**.
