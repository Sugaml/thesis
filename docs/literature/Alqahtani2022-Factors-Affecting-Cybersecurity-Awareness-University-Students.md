# Factors Affecting Cybersecurity Awareness University Students (2022)

## Paper Metadata
- **Source file:** `Alqahtani2022-Factors-Affecting-Cybersecurity-Awareness-University-Students.pdf`
- **Lead author key (from filename):** Alqahtani
...
- Alqahtani (2022) found that students with stronger password security practices were significantly more likely to also adopt other risk mitigation measures, suggesting that password behaviour serves as a gateway to a broader security posture.
